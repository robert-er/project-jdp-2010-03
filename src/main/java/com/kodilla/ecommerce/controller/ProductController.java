...
public class ProductController {
    ...
    public List<ProductDto> getProducts() {
       ...
       products.add(new ProductDto(2L, "Second Product", new BigDecimal(344), "Example description", 10L));
       products.add(new ProductDto(3L, "Third Product", new BigDecimal(327),"Example description", 80L));
